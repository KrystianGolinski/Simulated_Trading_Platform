...
class SimulationConfig(BaseModel):
    ...
    def validate_model(self):
        ...
        # Additional validation includes temporal validation, symbol existence, etc.
...
class SimulationResults(BaseModel):
    ...
    performance_metrics: Optional[PerformanceMetrics] = None  # Detailed performance analysis
