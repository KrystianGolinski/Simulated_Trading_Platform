...
class ComprehensiveAPITestSuite:
    ...
    def _test_root_endpoint(self):
        if not self._check_client_available(): return True
    ...
    def _test_service_components(self):
        ...
        return hasattr(processor, 'parse_json_result') and hasattr(handler, 'create_generic_error')
    ...
    def _test_edge_cases(self):
        ...
        if not self._check_client_available(): return True
        response = self.client.post("/simulation/validate", data="{invalid json}", headers={"Content-Type": "application/json"})
