...
class ErrorCode(Enum):
    ...
    ENGINE_NOT_EXECUTABLE = "ENGINE_NOT_EXECUTABLE"        # Engine file lacks execute permissions
    
    # Execution Errors - Process execution and runtime failures
    PROCESS_EXECUTION_FAILED = "PROCESS_EXECUTION_FAILED"  # General process execution failure
    PROCESS_TIMEOUT = "PROCESS_TIMEOUT"                    # Process killed due to timeout
    INVALID_WORKING_DIRECTORY = "INVALID_WORKING_DIRECTORY" # Invalid or inaccessible working directory
    ...
    MISSING_REQUIRED_FIELDS = "MISSING_REQUIRED_FIELDS"    # Required fields missing from data
    
    # Simulation Errors - Simulation-specific configuration and state issues
    SIMULATION_NOT_FOUND = "SIMULATION_NOT_FOUND"          # Requested simulation doesn't exist
    SIMULATION_ALREADY_RUNNING = "SIMULATION_ALREADY_RUNNING" # Simulation already in progress
    INVALID_SIMULATION_CONFIG = "INVALID_SIMULATION_CONFIG" # Invalid simulation configuration
