...
class ErrorHandler:
    ...
    def create_engine_validation_error(
        ...
        error_code = error_code_mapping.get(
            validation_result.get("error_code"), ErrorCode.UNKNOWN_ERROR
        )
    ...
    def categorize_cpp_engine_error(
        ...
        context = {
            ...
            "cpp_error_details": self.cpp_error_extractor.extract_cpp_error_details(
                stderr, stdout
            ),
        }
    ...
    def create_json_parse_error(
        self, json_error: str, raw_output: str
    ) -> SimulationError:
        error = SimulationError(
    ...
    def create_validation_error(
        self, validation_message: str, context: Optional[Dict[str, Any]] = None
    ) -> SimulationError:
        error = SimulationError(
    ...
    def get_error_statistics(self) -> Dict[str, Any]:
        ...
        for error in self.error_history:
            error_counts[error.error_code.value] = (
                error_counts.get(error.error_code.value, 0) + 1
            )
